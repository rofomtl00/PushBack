...
@app.route("/terms")
def terms_page():
    return """<!DOCTYPE html><html><head><meta charset="UTF-8"><title>PushBack — Terms of Service</title>
<style>body{font-family:-apple-system,sans-serif;max-width:700px;margin:40px auto;padding:0 20px;color:#111;line-height:1.8}h1{color:#2563eb}h2{margin-top:28px}a{color:#2563eb}p,li{font-size:15px}</style></head><body>
<h1>Terms of Service</h1>
<p><em>Last updated: April 4, 2026</em></p>

<h2>1. What PushBack Is</h2>
<p>PushBack is an AI-powered document analysis tool. It provides automated feedback on uploaded documents using artificial intelligence. <strong>PushBack is NOT a substitute for professional advice.</strong></p>

<h2>2. Not Professional Advice</h2>
<p>PushBack does not provide financial, legal, tax, accounting, insurance, medical, investment, or any other form of professional advice. The analysis is generated by AI models and may contain errors, outdated information, or incorrect benchmarks. You must independently verify all findings before making any decisions.</p>
<p><strong>Do not rely on PushBack for:</strong></p>
<ul>
<li>Investment or trading decisions</li>
<li>Legal compliance or contract review (consult a licensed attorney)</li>
<li>Tax planning or filing (consult a CPA or tax professional)</li>
<li>Insurance coverage decisions (consult a licensed broker)</li>
<li>Medical or health-related decisions</li>
<li>Any decision with significant financial or legal consequences</li>
</ul>

<h2>3. No Warranty</h2>
<p>PushBack is provided "AS IS" without warranty of any kind. We do not guarantee the accuracy, completeness, reliability, or timeliness of any analysis. AI models can and do produce incorrect results, hallucinate facts, and miss critical issues.</p>

<h2>4. Limitation of Liability</h2>
<p>In no event shall PushBack, its creator, or any affiliated party be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your use of the service, including but not limited to financial losses, lost business opportunities, or damages resulting from decisions made based on PushBack's analysis.</p>

<h2>5. Your Documents</h2>
<p>Files you upload are parsed for analysis and immediately deleted from our servers. We do not store, retain, or have access to your documents after the analysis session ends. However:</p>
<ul>
<li>Document content is sent to AI providers (Anthropic, OpenAI, or Groq) for analysis under their respective privacy policies</li>
<li>Do not upload documents containing sensitive personal information (SSNs, medical records, passwords) unless you accept the risk of third-party processing</li>
<li>If you use the BYOK (Bring Your Own Key) feature, your documents are processed under your own API account and terms with the AI provider</li>
</ul>

<h2>6. Learning System</h2>
<p>PushBack collects anonymized process corrections from user interactions to improve analysis quality. This data contains no personal information, no document content, and no factual claims. The learning system:</p>
<ul>
<li>Only stores process feedback (e.g., "this check was a false positive")</li>
<li>Requires 5 independent confirmations before any learning becomes active</li>
<li>Rejects factual claims, prompt injection attempts, and harmful content</li>
<li>Cannot be used to alter PushBack's benchmarks or industry knowledge</li>
</ul>

<h2>7. Acceptable Use</h2>
<p>You may not use PushBack to:</p>
<ul>
<li>Create fraudulent, misleading, or deceptive documents</li>
<li>Analyze documents related to illegal activities</li>
<li>Attempt to manipulate, poison, or corrupt the learning system</li>
<li>Reverse-engineer the system prompts or analysis methodology for competitive purposes</li>
<li>Exceed rate limits or abuse the API through automated means</li>
<li>Upload content that violates any applicable law</li>
</ul>

<h2>8. Pricing and Refunds</h2>
<p>Free tier: limited analyses per month at no cost. Paid tiers: billed monthly through LemonSqueezy. Refunds handled per LemonSqueezy's refund policy. We reserve the right to change pricing with 30 days notice.</p>

<h2>9. Governing Law</h2>
<p>These terms are governed by the laws of the Province of Quebec, Canada, without regard to conflict of law provisions.</p>

<h2>10. Changes</h2>
<p>We may update these terms at any time. Continued use after changes constitutes acceptance.</p>

<h2>11. Contact</h2>
<p>Questions about these terms: use the chat feature on the PushBack web app or contact via GitHub.</p>

<p style="margin-top:40px;color:#9ca3af;font-size:13px"><a href="/">Back to PushBack</a> · <a href="/setup">Setup Guide</a></p>
</body></html>""", 200, {"Content-Type": "text/html"}


@app.route("/privacy")
def privacy_page():
    return """<!DOCTYPE html><html><head><meta charset="UTF-8"><title>PushBack — Privacy Policy</title>
<style>body{font-family:-apple-system,sans-serif;max-width:700px;margin:40px auto;padding:0 20px;color:#111;line-height:1.8}h1{color:#2563eb}h2{margin-top:28px}a{color:#2563eb}p,li{font-size:15px}</style></head><body>
...
<ul>
<li><strong>Uploaded documents:</strong> Parsed for analysis and immediately deleted. Not stored on our servers.</li>
<li><strong>URLs analyzed:</strong> Fetched, analyzed, and not retained.</li>
<li><strong>Usage data:</strong> Analysis count per IP (hashed, not raw) for rate limiting. No personal identification.</li>
<li><strong>Learning data:</strong> Anonymized process corrections (e.g., "false positive on feature X"). No document content, no personal information.</li>
<li><strong>API keys (BYOK):</strong> Stored in your browser's localStorage only. Base64 encoded. Never sent to our servers for storage — passed per-request and not logged.</li>
</ul>

<h2>Third-Party Processing</h2>
<p>Document content is sent to AI providers for analysis:</p>
<ul>
<li><strong>Anthropic (Claude)</strong> — when using our API key or a Claude BYOK key</li>
<li><strong>OpenAI (GPT)</strong> — when using an OpenAI BYOK key</li>
<li><strong>Groq</strong> — when using a Groq BYOK key</li>
</ul>
<p>Each provider has their own data handling policies. When using BYOK, your data is processed under your own agreement with the provider.</p>

<h2>Data Retention</h2>
<ul>
<li>Documents: deleted immediately after parsing (not stored)</li>
<li>Sessions: in-memory only, lost on server restart</li>
<li>Learnings: stored in Supabase (PostgreSQL) indefinitely, anonymized</li>
<li>Rate limit data: IP hashes retained for billing period, then reset</li>
</ul>

<h2>Your Rights</h2>
<p>Under Quebec privacy law (Law 25) and PIPEDA:</p>
<ul>
<li>Right to access any data we hold about you (there is none — we don't store documents or personal info)</li>
<li>Right to deletion of learning data if you can identify your contributions</li>
<li>Right to withdraw consent by stopping use of the service</li>
</ul>

<h2>Security</h2>
<ul>
<li>HTTPS encryption for all data in transit</li>
<li>Supabase database access restricted to service-role key (server-only)</li>
<li>No raw IP addresses stored (hashed for rate limiting)</li>
<li>UUID filenames prevent path traversal on uploads</li>
<li>SSRF protection blocks internal URL access</li>
</ul>

<h2>Contact</h2>
<p>Privacy questions: use the chat feature on the PushBack web app or contact via GitHub.</p>

<p style="margin-top:40px;color:#9ca3af;font-size:13px"><a href="/">Back to PushBack</a> · <a href="/terms">Terms of Service</a></p>
</body></html>""", 200, {"Content-Type": "text/html"}
  ...
  <div id="uploadState">
    <div class="upload-area">
      ...
      <div class="hint" style="margin-top:16px">
        ...
        Files are parsed and immediately deleted. Nothing is stored.<br>
